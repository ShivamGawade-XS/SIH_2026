  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-20 left-3 sm:bottom-6 sm:left-6 z-40 px-3.5 py-2.5 bg-[#121212] hover:bg-[#1A1A1A] text-white font-bold text-sm md:text-xs uppercase tracking-wider shadow-2xl flex items-center gap-2 transition-all hover:scale-105 active:scale-95 border-2 border-gold"
      >
        <Award className="w-4 h-4 text-gold shrink-0" />
        <span className="hidden sm:inline">SIH 2026 Jury Brief</span>
        <span className="sm:hidden">Jury Brief</span>
        <span className="bg-black text-gold border border-gold/40 font-mono text-sm md:text-xs md:text-[10px] md:text-[9px] px-1.5 py-0.5">
          SIH26021
        </span>
      </button>
          ...
          <div className="bg-[#141414] border-2 border-gold max-w-4xl w-full max-h-[92vh] flex flex-col shadow-2xl overflow-hidden text-[#F9F8F6]">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="px-2 py-0.5 text-sm md:text-xs md:text-[10px] md:text-[9px] font-mono font-bold text-gold border border-gold/40 bg-gold/10">
                      PS SIH26021
                    </span>
                  </div>
                  <p className="text-sm md:text-xs text-warm-grey mt-0.5">
            ...
            <div className="flex border-b border-white/15 bg-[#141414] px-6 overflow-x-auto scrollbar-none">
              {[
                ...
                <button
                  ...
                  className={`px-4 py-3 text-sm md:text-xs font-bold uppercase tracking-wider border-b-2 transition-colors whitespace-nowrap ${
                    activeTab === tab.id
            ...
            <div className="p-6 overflow-y-auto space-y-6 flex-1 text-sm leading-relaxed">
              ...
              {activeTab === "overview" && (
                <div className="space-y-6">
                  <div className="p-4 bg-gold/10 border border-gold/40">
                    <p className="text-sm md:text-xs uppercase font-bold text-gold tracking-wider mb-1">The Problem Statement</p>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    <div className="p-4 bg-[#1A1A1A] border border-white/10">
                      ...
                      <p className="text-sm md:text-xs text-warm-grey mt-1">Beekeepers Registered</p>
                    </div>
                    <div className="p-4 bg-[#1A1A1A] border border-white/10">
                      <p className="text-2xl serif font-bold text-emerald-400">99.4%</p>
                      <p className="text-sm md:text-xs text-warm-grey mt-1">FSSAI Compliance</p>
                    </div>
                    <div className="p-4 bg-[#1A1A1A] border border-white/10">
                      <p className="text-2xl serif font-bold text-alabaster">&lt;3 sec</p>
                      <p className="text-sm md:text-xs text-warm-grey mt-1">Consumer Verification</p>
                    </div>
                    <div className="p-4 bg-[#1A1A1A] border border-white/10">
                      <p className="text-2xl serif font-bold text-gold-light">0.0%</p>
                      <p className="text-sm md:text-xs text-warm-grey mt-1">Farmer Tipping Fee</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              {activeTab === "innovations" && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-[#1A1A1A] border border-white/10 space-y-2">
                    <div className="flex items-center gap-2 text-gold font-bold text-sm md:text-xs uppercase tracking-wider">
                      <FlaskConical className="w-4 h-4" />
                      <span>1. Physics-Bounded AI Scoring</span>
                    </div>
                    <p className="text-sm md:text-xs text-taupe/80 leading-relaxed">
              ...
              {activeTab === "architecture" && (
                <div className="space-y-4 font-mono text-sm md:text-xs">
              ...
              {activeTab === "defense" && (
                <div className="space-y-3">
                  <div className="p-4 bg-[#1A1A1A] border border-white/10 space-y-1">
                    <p className="text-gold font-bold text-sm md:text-xs uppercase">Q: What if a fraudster photocopies a genuine jar QR code?</p>
                    <p className="text-sm md:text-xs text-taupe/80 leading-relaxed">
                  ...
                  <div className="p-4 bg-[#1A1A1A] border border-white/10 space-y-1">
                    <p className="text-gold font-bold text-sm md:text-xs uppercase">Q: How do poor rural beekeepers afford Polygon blockchain gas fees?</p>
                    <p className="text-sm md:text-xs text-taupe/80 leading-relaxed">
                  ...
                  <div className="p-4 bg-[#1A1A1A] border border-white/10 space-y-1">
                    <p className="text-gold font-bold text-sm md:text-xs uppercase">Q: How does this work in areas with zero 4G/5G mobile connectivity?</p>
                    <p className="text-sm md:text-xs text-taupe/80 leading-relaxed">
            ...
            {/* Modal Footer */}
            <div className="px-6 py-4 border-t border-white/15 bg-[#1A1A1A] flex justify-between items-center text-sm md:text-xs">
              <span className="text-warm-grey">Smart India Hackathon 2026 Grand Finale</span>
              <button
                type="button"
                onClick={() => setIsOpen(false)}
                className="px-4 py-2 bg-gold hover:bg-gold-light text-charcoal font-bold text-sm md:text-xs uppercase tracking-wider"
              >
                Close Brief
              </button>
            </div>
