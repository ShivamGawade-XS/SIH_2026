      ...
      <div className="flex flex-col lg:flex-row gap-12 items-center">
        ...
        <div className="w-full lg:w-5/12 overflow-hidden border border-charcoal/20 relative">
          <div className="aspect-[3/4] relative bg-charcoal">
            ...
            />
            <div className="absolute top-4 left-4 bg-charcoal text-gold px-3 py-1 text-sm md:text-xs md:text-[10px] uppercase tracking-widest font-semibold flex items-center gap-1.5 border border-gold/40">
        ...
        <div className="w-full lg:w-7/12 flex flex-col justify-between">
          <div>
            <p className="text-sm md:text-xs md:text-[10px] uppercase tracking-widest text-warm-grey mb-3">The Source • Primary Producer</p>
            <h3 className="text-4xl md:text-5xl serif text-charcoal mb-4 font-normal">
              {farmer.name}
            </h3>

            <div className="space-y-4 my-8">
              <div className="flex items-center gap-3 text-sm md:text-xs text-charcoal">
            ...
            <p className="text-sm md:text-xs text-warm-grey leading-relaxed border-t border-charcoal/10 pt-6">
          ...
          <div className="mt-8 pt-6 border-t border-charcoal/10 flex items-center justify-between">
            <span className="text-sm md:text-xs md:text-[10px] uppercase tracking-widest text-warm-grey">Farmer ID #00{farmer.farmerId}</span>
            <span className="text-sm md:text-xs md:text-[10px] font-mono text-emerald-700 font-semibold uppercase tracking-widest bg-emerald-50 px-2.5 py-1 border border-emerald-200">
