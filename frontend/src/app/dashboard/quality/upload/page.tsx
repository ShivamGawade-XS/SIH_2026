    ...
    <div className="min-h-screen flex flex-col justify-between bg-[#F9F8F6]">
      ...
      <main className="py-16 px-6 md:px-12 max-w-5xl mx-auto w-full flex-1">
        <Link
          ...
          className="inline-flex items-center gap-2 text-sm md:text-xs uppercase tracking-widest text-warm-grey hover:text-charcoal transition-colors mb-8"
        >
        ...
        <div className="border-2 border-charcoal/20 bg-white p-8 md:p-12 shadow-luxury-card mb-8">
          <div className="flex items-center gap-4 mb-8 pb-6 border-b border-charcoal/10">
            ...
            <div>
              <p className="text-sm md:text-xs md:text-[10px] uppercase tracking-ultra text-warm-grey font-bold">Multimodal AI Vision & OCR</p>
          ...
          <form onSubmit={handleAnalyze} className="space-y-8">
            ...
            <div>
              <div className="block text-sm md:text-xs md:text-[10px] uppercase tracking-widest text-warm-grey mb-2 font-bold">
              ...
              <div className="border-2 border-dashed border-charcoal/30 hover:border-gold p-8 text-center bg-alabaster/40 transition-colors">
                ...
                <label htmlFor="labFile" className="cursor-pointer block">
                  ...
                  <p className="text-sm md:text-xs font-bold text-charcoal uppercase tracking-wider mb-1">
                    {file ? file.name : "Click to Browse or Drag Certificate Image Here"}
                  </p>
                  <p className="text-sm md:text-xs md:text-[10px] text-warm-grey">
            ...
            <div>
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-1 mb-2">
                <label htmlFor="labTranscript" className="text-sm md:text-xs md:text-[10px] uppercase tracking-widest text-warm-grey font-bold">
                  2. Or Paste Raw Lab Test Transcript / Text
                </label>
                <button
                  type="button"
                  onClick={handleLoadSampleReport}
                  className="text-sm md:text-xs md:text-[10px] uppercase tracking-widest text-gold hover:text-charcoal font-bold underline"
                >
              ...
              <textarea
                ...
                className="w-full border border-charcoal/30 p-3 text-sm md:text-xs font-mono focus:border-gold focus:outline-none"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-14 bg-charcoal text-alabaster uppercase tracking-widest text-sm md:text-xs font-bold btn-gold-slide flex items-center justify-center gap-3 shadow-md"
            >
              {loading ? (
                <>
        ...
        {extractedData && qualityResult && (
          <div className="border-2 border-gold bg-white p-8 md:p-12 shadow-2xl animate-in fade-in zoom-in-95 duration-200">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8 pb-6 border-b border-charcoal/10">
              <div>
                <span className="text-sm md:text-xs md:text-[10px] uppercase tracking-ultra text-gold font-bold block mb-1">
                  AI Vision Extraction Complete
                </span>
                <h2 className="text-3xl serif text-charcoal font-bold">
                  Laboratory Analysis & Purity Assessment
                </h2>
                <p className="text-sm md:text-xs text-warm-grey font-mono mt-1">Engine: {engineUsed}</p>
              </div>
              <div className="text-right">
                <span className="text-sm md:text-xs md:text-[10px] uppercase tracking-widest text-warm-grey block">FSSAI Purity Score</span>
                ...
                <span className="text-sm md:text-xs md:text-[10px] uppercase tracking-wider font-bold text-emerald-700 block">
                  {qualityResult.grade}
                </span>
              </div>
            </div>
            ...
            <div className="mb-8">
              <h3 className="text-sm md:text-xs uppercase tracking-widest font-bold text-charcoal mb-4">
                Extracted Physicochemical Parameters (FSSAI IS 4941:2020)
              </h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="p-4 bg-[#F9F8F6] border border-charcoal/10">
                  <span className="text-sm md:text-xs md:text-[10px] md:text-[9px] uppercase tracking-widest text-warm-grey block mb-1">Moisture Content</span>
                  <span className="text-xl font-mono font-bold text-charcoal">{extractedData.moisture_percent}%</span>
                  <span className="text-sm md:text-xs md:text-[10px] md:text-[9px] text-emerald-700 block mt-1">FSSAI Max: 20.0%</span>
                </div>
                <div className="p-4 bg-[#F9F8F6] border border-charcoal/10">
                  <span className="text-sm md:text-xs md:text-[10px] md:text-[9px] uppercase tracking-widest text-warm-grey block mb-1">Brix Density</span>
                  <span className="text-xl font-mono font-bold text-charcoal">{extractedData.brix_index}°Bx</span>
                  <span className="text-sm md:text-xs md:text-[10px] md:text-[9px] text-emerald-700 block mt-1">Standard: &gt; 80°</span>
                </div>
                <div className="p-4 bg-[#F9F8F6] border border-charcoal/10">
                  <span className="text-sm md:text-xs md:text-[10px] md:text-[9px] uppercase tracking-widest text-warm-grey block mb-1">HMF Freshness</span>
                  <span className="text-xl font-mono font-bold text-charcoal">{extractedData.hmf_mg_kg} mg/kg</span>
                  <span className="text-sm md:text-xs md:text-[10px] md:text-[9px] text-emerald-700 block mt-1">Limit: Max 80.0</span>
                </div>
                <div className="p-4 bg-[#F9F8F6] border border-charcoal/10">
                  <span className="text-sm md:text-xs md:text-[10px] md:text-[9px] uppercase tracking-widest text-warm-grey block mb-1">Diastase Index</span>
                  <span className="text-xl font-mono font-bold text-charcoal">{extractedData.diastase_activity} DN</span>
                  <span className="text-sm md:text-xs md:text-[10px] md:text-[9px] text-emerald-700 block mt-1">Min: 8.0 DN</span>
                </div>
                <div className="p-4 bg-[#F9F8F6] border border-charcoal/10">
                  <span className="text-sm md:text-xs md:text-[10px] md:text-[9px] uppercase tracking-widest text-warm-grey block mb-1">Conductivity</span>
                  <span className="text-xl font-mono font-bold text-charcoal">{extractedData.electrical_conductivity} mS/cm</span>
                  <span className="text-sm md:text-xs md:text-[10px] md:text-[9px] text-emerald-700 block mt-1">Max: 0.8 mS/cm</span>
                </div>
                <div className="p-4 bg-[#F9F8F6] border border-charcoal/10">
                  <span className="text-sm md:text-xs md:text-[10px] md:text-[9px] uppercase tracking-widest text-warm-grey block mb-1">Delta 13C Isotope</span>
                  <span className="text-xl font-mono font-bold text-charcoal">{extractedData.c13_isotope_delta} ‰</span>
                  <span className="text-sm md:text-xs md:text-[10px] md:text-[9px] text-emerald-700 block mt-1">Authentic: &lt; -24.0</span>
                </div>
                <div className="p-4 bg-[#F9F8F6] border border-charcoal/10">
                  <span className="text-sm md:text-xs md:text-[10px] md:text-[9px] uppercase tracking-widest text-warm-grey block mb-1">C4 Exogenous Sugars</span>
                  <span className="text-xl font-mono font-bold text-charcoal">{extractedData.c4_sugar_percent}%</span>
                  <span className="text-sm md:text-xs md:text-[10px] md:text-[9px] text-emerald-700 block mt-1">Max: 7.0%</span>
                </div>
                <div className="p-4 bg-[#F9F8F6] border border-charcoal/10">
                  <span className="text-sm md:text-xs md:text-[10px] md:text-[9px] uppercase tracking-widest text-warm-grey block mb-1">SMR Rice Syrup</span>
                  <span className="text-xl font-mono font-bold text-charcoal">{extractedData.smr_marker}</span>
                  <span className="text-sm md:text-xs md:text-[10px] md:text-[9px] text-emerald-700 block mt-1">Marker: Negative</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 bg-charcoal text-alabaster flex flex-col sm:flex-row justify-between items-center gap-4 mb-8">
              <div>
                <span className="text-sm md:text-xs md:text-[10px] md:text-[9px] uppercase tracking-ultra text-gold font-bold">Adulteration Fingerprint Classification</span>
                <p className="text-lg font-serif font-bold text-alabaster">{qualityResult.adulterant_fingerprint}</p>
              </div>
              <Link
                href="/dashboard/mint"
                className="px-6 py-3 bg-gold text-charcoal uppercase tracking-widest text-sm md:text-xs font-bold hover:bg-white transition-colors"
              >
